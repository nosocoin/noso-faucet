...
class faucetView{
    ...
    private function view(){
        ...
        <h6 class="subtitle is-6 has-text-grey"> Rewards: <strong class="has-text-warning-dark">'.$_ENV['NOSO_PAY'].' NOSO </strong> every  '.$this->coreFunctional->setTime($_ENV['CLAIM_TIME']).'</h6>'.PHP_EOL;



/**
 * Здесь нужно сделать метод который будет проверять тайминг между запросами
 * и доступность притензии
 */
